        ...
        counterButton.addEventListener('click', (e) => {
            ...
            .then(data => {
                if (data.error) {
                    ...
                    localCounter.textContent = data.count;
                    error.textContent = '';
                }
            })
            .catch(err => {
                console.error('Error updating count:', err);
                error.textContent = 'Error updating count.';
            });
            triggerRipple(e);
            playKuru();
            animateHerta();
    ...
    window.onload = function () {
        ...
        fetch('app/get_count.php')
            ...
            .catch(err => {
                ...
                error.textContent = 'Error fetching initial count.';
            });
    }
